...
TEST(Type, Int128LeftShiftOperator) {
  int64_t up = 0xFFFFFFFFFFFFFFFA;
  uint64_t low = 0xDDDDDDDDDDDDDDDD;
  Int128 testHexVal(MERGE_INT128(up, low));

  EXPECT_EQ(testHexVal, testHexVal << 0);
  EXPECT_EQ(Int128(0), testHexVal << 128);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFAD, 0xDDDDDDDDDDDDDDD0)),
      testHexVal << 4);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFF5, 0xBBBBBBBBBBBBBBBA)),
      testHexVal << 1);
  EXPECT_EQ(Int128(MERGE_INT128(0x8000000000000000, 0)), testHexVal << 127);

  EXPECT_EQ(Int128(MERGE_INT128(0xD000000000000000, 0)), testHexVal << 124);
  EXPECT_EQ(Int128(MERGE_INT128(0xDDDDDDDDDDDDDDDD, 0)), testHexVal << 64);
  EXPECT_EQ(Int128(MERGE_INT128(0xDDDDDDDDDDDDDDD0, 0)), testHexVal << 68);

  up = 0xA;
  testHexVal = MERGE_INT128(up, low);
  EXPECT_EQ(
      Int128(MERGE_INT128(0x0000000000000056, 0xEEEEEEEEEEEEEEE8)),
      testHexVal << 3);

  EXPECT_EQ(
      Int128(MERGE_INT128(0x00000000000000AD, 0xDDDDDDDDDDDDDDD0)),
      testHexVal << 4);
}

TEST(Type, Int128RightShiftOperator) {
  int64_t up = 0xFFFFFFFFFFFFFFFA;
  uint64_t low = 0xDDDDDDDDDDDDDDDD;
  Int128 testHexVal(MERGE_INT128(up, low));
  EXPECT_EQ(testHexVal, testHexVal >> 0);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF)),
      testHexVal >> 128);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFA)),
      testHexVal >> 64);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFF5)),
      testHexVal >> 63);

  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFFF, 0xADDDDDDDDDDDDDDD)),
      testHexVal >> 4);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFFF, 0x5BBBBBBBBBBBBBBB)),
      testHexVal >> 3);
  testHexVal = MERGE_INT128(0xFFFFFFFFFFFFFFCA, 0xEEEEEEEEEEEEEEEE);
  EXPECT_EQ(
      Int128(MERGE_INT128(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFC)),
      testHexVal >> 68);
  testHexVal = MERGE_INT128(0x7777777777777777, 0xEEEEEEEEEEEEEEEE);
  EXPECT_EQ(Int128(MERGE_INT128(0, 0)), testHexVal >> 127);
  EXPECT_EQ(Int128(MERGE_INT128(0, 0x0000000000000007)), testHexVal >> 124);
  EXPECT_EQ(
      Int128(MERGE_INT128(0x0000000000000000, 0x7777777777777777)),
      testHexVal >> 64);
}
